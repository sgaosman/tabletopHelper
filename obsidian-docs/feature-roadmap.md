...
**Status:** Complete — 330 tests (220 backend + 110 frontend), all passing.

**Detailed test plan:** See [[m25-test-plan]] for full Given/When/Then specs and acceptance criteria.

**Backend tests (220):**

| Test File | Tests |
|---|---|
| CombatServiceTest | 32 |
| FeatEffectResolverTest | 19 |
| SpellSlotCalculatorTest | 17 |
| LevelUpCalculatorTest | 17 |
| CharacterJsonHelperTest | 16 |
| MulticlassValidatorTest | 14 |
| EncounterServiceTest | 12 |
| FiveEToolsMarkupParserTest | 11 |
| CharacterServiceStaticTest | 10 |
| CharacterServiceBusinessTest | 22 |
| LevelUpDownRoundTripTest | 18 |
| DiceRollerTest | 8 |
| AuthServiceTest | 6 |
| JwtTokenProviderTest | 4 |
| CampaignServiceTest | 4 |
| CharacterMapperTest | 4 |
...
| Test File | Tests |
|---|---|
| wizard/helpers.test.ts | 33 |
| spellConstants.test.ts | 28 |
| parseMarkup.test.ts | 14 |
| featPrerequisites.test.ts | 14 |
| dndRules.test.ts | 11 |
| featSpellParser.test.ts | 10 |

**Key decisions:** D102 in [[decisions-log]]

**Also implemented:** `shortRest()` and `longRest()` methods in CharacterService, spell stat recalculation on ability score updates, `ShortRestRequest` DTO.
